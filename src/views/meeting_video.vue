            ...
            <div class="video-list">
              <div class="video">
                <div class="user">
                  ...
                  <span class="name"
                    >{{ mine.name }}{{ shareStatus ? "（共享中）" : "" }}</span
                  >
                </div>
                <div id="localStream"></div>
              </div>
              <div class="video" v-for="one in memberList" :key="one.id">
                <div class="user">
                ...
                <div
                  :id="one.id"
                  class="remote-stream"
                  @dblclick="bigVideoHandle(one.id)"
                ></div>
              </div>
            </div>
          </el-scrollbar>
      ...
      <el-col :span="5">
        <el-card shadow="never">
          ...
          <el-scrollbar height="555px">
            <ul class="user-list">
              <li v-for="one in userList" :key="one.userId">
        ...
        <div class="meeting-operate">
          ...
          ></button>
          <button
            :class="micStatus ? 'mic-btn-on' : 'mic-btn-off'"
            @click="micHandle"
          ></button>
          <button
...
export default {
  ...
  created: function () {
    ...
    that.$http(
      "meeting/searchOnlineMeetingMembers",
      "POST",
      data,
      true,
      function (resp) {

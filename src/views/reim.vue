<template>
  <div>
    ...
    >
      ...
      >
        <template #default="scope">
          <div class="reim-table">
            ...
            <div
              class="row"
              v-for="(one, $index) in scope.row.content"
              :key="$index"
            >
      ...
      >
        <template #default="scope">
          <el-button type="text" size="medium" @click="pdfHandle(scope.row.id)">
            报销单
          </el-button>
          <el-button
            type="text"
            ...
            :disabled="
              !(
                ['待审批', '已否决'].includes(scope.row.status) &&
                scope.row.mine == 'true'
              )
            "

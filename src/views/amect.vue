      ...
      >
        <template #default="scope">
          <el-button
            ...
            :disabled="
              !(
                isAuth(['ROOT', 'AMECT:UPDATE']) && scope.row.status != '已缴纳'
              )
            "
          ...
          <el-button
            ...
            :disabled="
              !(
                isAuth(['ROOT', 'AMECT:DELETE']) && scope.row.status != '已缴纳'
              )
            "
          ...
          <el-button
            ...
            size="medium"
            :disabled="
              !(scope.row.mine == 'true' && scope.row.status == '未缴纳')
            "

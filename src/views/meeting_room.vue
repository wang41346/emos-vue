      ...
      >
        <template #default="scope">
          <el-button
            ...
            size="medium"
            :disabled="
              !isAuth(['ROOT', 'MEETING_ROOM:UPDATE']) || scope.row.id == 0
            "
          ...
          <el-button
            ...
            size="medium"
            :disabled="
              !isAuth(['ROOT', 'MEETING_ROOM:DELETE']) || scope.row.id == 0
            "
  ...
  methods: {
    loadDataList: function () {
      ...
      let data = {
        ...
        canDelete:
          that.dataForm.canDelete == "all" ? null : that.dataForm.canDelete,
        page: that.pageIndex,
        length: that.pageSize,
      };

      that.$http(
        "meeting_room/searchMeetingRoomByPage",
        "POST",
        data,
        true,
        function (resp) {

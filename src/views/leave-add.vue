...
export default {
  data: function () {
    return {
      ...
      disabledDate(date) {
        return dayjs(date.toLocaleDateString()).isBefore(
  ...
  methods: {
    ...
    dataFormSubmit: function () {
      ...
      let data = {
        ...
        start:
          dayjs(that.dataForm.startDate).format("YYYY-MM-DD") +
          " " +
          that.dataForm.startTime +
          ":00",
        end:
          dayjs(that.dataForm.endDate).format("YYYY-MM-DD") +
          " " +
          that.dataForm.endTime +
          ":00",
